...
export default function AddItem() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8080/items/add', requestBody);
  ...
  return (
    <div>
      <form className="addItem__form" onSubmit={handleSubmit}>
        <div>
          <label className="addItem__form-label" htmlFor="citizenship">
            Citizenship:
          </label>
          <input
            className={`addItem__form-input ${
        ...
        <div>
          <label className="addItem__form-label" htmlFor="photo">
            Photo:
          </label>
          <input
            type="file"
        ...
        <div>
          <label className="addItem__form-label" htmlFor="brand">
            Brand:
          </label>
          <input
            list="brandOptions"
        ...
        <div>
          <label className="addItem__form-label" htmlFor="type">
            Type:
          </label>
          <input
            className={`addItem__form-input ${
        ...
        <div>
          <label className="addItem__form-label" htmlFor="nickname">
            Nickname:
          </label>
          <input
            className={`addItem__form-input ${
        ...
        <div>
          <label className="addItem__form-label" htmlFor="size">
            Size:
          </label>
          <input
            className={`addItem__form-input ${
        ...
        <div>
          <label className="addItem__form-label" htmlFor="birthdate">
            Birthdate:
          </label>
          <input
            className={`addItem__form-input ${
        ...
        <div>
          <label className="addItem__form-label" htmlFor="serial_num">
            Serial Number
          </label>
          <input
            className={`addItem__form-input ${
